...
import com.jepongdevxyz.vpn.util.WorkerAction;
import com.jepongdevxyz.vpn.util.Worker2;
...
public class HostChecker extends AppCompatActivity  {
	...
	//	setModoNoturno(this);
        ...
        this.adapter = new ArrayAdapter(getApplicationContext(), R.layout.list_text, this.arrayList);
        this.list.setAdapter(this.adapter);
		Txthost1 = (TextView) findViewById(R.id.Txthost1);
		Txthost2 = (TextView) findViewById(R.id.Txthost2);
		...
		list.setOnItemLongClickListener(new OnItemLongClickListener() {
				...
				public boolean onItemLongClick(AdapterView<?> parent, View view,
					...
					Toast.makeText(HostChecker.this, "Copied Entry", Toast.LENGTH_SHORT).show();
					return true;
				}
			});
