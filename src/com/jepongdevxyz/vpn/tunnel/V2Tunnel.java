...
import com.jepongdevxyz.vpn.V2Configs;
import com.jepongdevxyz.vpn.V2Core;
import com.jepongdevxyz.vpn.V2Service;
...
public class V2Tunnel {
    ...
    public static void StartV2ray(final Context context, final String remark, final String config, final ArrayList<String> blocked_apps) {
        ...
        SkStatus.logInfo("<strong>" + mContext.getString(R.string.log_server_banner) + "</strong> " + "<br><br><b>Reglas y regulaciones del servidor</b><br><br><b><font color=#D50000>• NO SPAMMING!</b></font><br><b><font color=#D50000>• NO TORRENT!</b></font><br><b><font color=#D50000>• NO CARDING!</b></font><br><b><font color=#D50000>• NO HACKING!</b></font><br><b><font color=#D50000>• NO ILLEGAL ACTIVITIES!</b></font><br><br>Propietario: <b><font color=#2196F3>ADevz</font></b><br>");
        siNoInternet();
